...
COPYRIGHT      	db "DYNAMICS ROOM EDITOR V1.0: (C) 1994 FRANCOIS BLANCHETTE"
PATH	       	db 0
CREATSCRIPTFAILTEXT db"Unable to creat script file.$"
READERROROCCUREDTEXT db"Read error occured.$"
OVERWRITESCRIPTFAILTEXT db"Fatal error occured during the operation!$"
